...
var colorChoices = {
    ...
    'black': ['rgba(0,0,0,1)', 'rgba(193, 193, 193, .95)',   'rgba(0, 0, 0, 1)', 'rgba(193, 193, 193, 0.95)', 'rgba(193, 193, 193, 0.95)', 'rgba(193, 193, 193, 0.35)', 'rgba(255, 255, 255, 0.9)','rgb(211, 211, 211)', 'rgba(0, 0, 0, 1)','rgba(193, 193, 193, 0.95)'],
    'blue': ['rgba(115, 146, 172, .7)', 'rgba(229, 222, 222, .6)','rgba(0, 0, 0, 1)', 'rgba(255,255,255,.8)', 'rgba(229, 222, 222, 0.9)', 'rgb(169, 169, 169)', 'rgba(255,255,255,1)', 'rgba(255, 255, 255, .8)', 'rgba(115, 146, 172, 0.7)', 'rgba(115, 146, 172, 0.7)'],
  ...
  var updateColor = function(choiceElement) {
    ...
    $('.cv__aboutme--left').css({'background-color': colorChoices[choice][0]});
    ...
    $('.cv__aboutme--left .section__title--uppercase').css({'color': colorChoices[choice][4]});
    $('.list__bullet').css({'background-color': colorChoices[choice][8]});
    $('.cv__personal__items i').css({'color': colorChoices[choice][7]});
